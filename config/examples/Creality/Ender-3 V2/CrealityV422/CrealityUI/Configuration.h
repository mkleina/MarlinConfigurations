...
#define PIDTEMPBED
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 88.97
  #define DEFAULT_bedKi  15.03
  #define DEFAULT_bedKd 351.13
...
#define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 60, 60, 1.2, 20 } // ...or, set your own edit limits
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -6, -1.20 }
